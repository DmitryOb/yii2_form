					...
					<tbody>
						...
						<tr>
							<td style="font: 16px Arial, sans-serif;line-height: 20px;padding: 0 30px 10px;">
								...
								Html::a(
									'№ '.$formid,
									Url::toRoute(['admin/form/view', 'id' => $formid], true),
									[
										'target' => '_blank',
					...
					<tbody>
						<tr>
							<td style="font-family:Arial,sans-serif;font-size: 12px;line-height: 16px;color: #999999;text-align: center;padding: 30px 5px;">
								...
								<?= Html::a($to, 'mailto:'.$to, ['target' => '_blank']) ?>
								автоматически. При возникновении вопросов вы можете обратиться в техподдержку
								<?= Html::a('TopHotels', 'https://tophotels.ru/feedback') ?>
							</td>
						</tr>
					</tbody>
				</table>
